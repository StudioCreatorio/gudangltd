...
?>
<div data-condition-editor="cronjob" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="cronjob">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if WordPress is doing a cronjob.', 'wp-shifty');?></div>
