...
?>
<div data-condition-editor="header" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="header">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if specified HTTP header is present and the value is met with the condition. Use Regex match and (.*) to match any value', 'wp-shifty');?></div>
