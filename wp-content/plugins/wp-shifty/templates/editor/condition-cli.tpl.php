...
?>
<div data-condition-editor="cli" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="cli">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if WordPress is running in command line mode.', 'wp-shifty');?></div>
