...
?>
<div data-condition-editor="search" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="search">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met on search result pages.', 'wp-shifty');?></div>
