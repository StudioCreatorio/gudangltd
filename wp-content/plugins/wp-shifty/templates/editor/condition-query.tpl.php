...
?>
<div data-condition-editor="query" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="query">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if specified GET parameter is present and the value is met with the condition. Use Regex match and (.*) to match any value', 'wp-shifty');?></div>
