...
?>
<div data-condition-editor="post-data" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="post-data">
      ...
      <textarea class="wpshifty-multiline-input" name="condition[%ID][data]" placeholder="key=value&key2=value2"><?php WP_Shifty_Editor::maybe_textarea($_condition, 'data');?></textarea>
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if the request is exactly match with the specified POST data', 'wp-shifty');?></div>
