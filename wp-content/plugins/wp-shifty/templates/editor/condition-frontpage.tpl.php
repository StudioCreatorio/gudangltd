...
?>
<div data-condition-editor="frontpage" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="frontpage">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met on the home page (Home URL).', 'wp-shifty');?></div>
