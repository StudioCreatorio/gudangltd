...
?>
<div data-condition-editor="frontend" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="frontend">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met on frontend, except AJAX requests.', 'wp-shifty');?></div>
