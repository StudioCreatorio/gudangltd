...
?>
<div data-condition-editor="author" data-condition-id="%ID" class="wpshifty-hidden">
      <input type="hidden" name="condition[%ID][type]" value="author">
      ...
      <div class="wpshifty-condition-info"><?php esc_html_e('The condition is met if the current page is an author archive page.', 'wp-shifty');?></div>
