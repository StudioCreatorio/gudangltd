...
class WP_Shifty_Dom {
	...
	function __construct($str=null, $lowercase=true, $forceTagsClosed=true, $target_charset='UTF-8', $stripRN=true, $defaultBRText="\r\n", $defaultSpanText = " ")
	{
		if ($str)
		{
	...
	protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText="\r\n", $defaultSpanText= " ")
	{
		...
		$this->root = new WP_Shifty_Dom_Node($this);
		$this->root->tag = 'root';
		$this->root->_[0] = -1;
	...
	protected function parse()
	{
		...
		// text
		$node = new WP_Shifty_Dom_Node($this);
		++$this->cursor;
		$node->_[4] = $s;
	...
	protected function read_tag()
	{
		...
		{
			$this->char = (++$this->pos<$this->size) ? $this->doc[$this->pos] : null; // next
			// This represents the change in the WP_Shifty_Dom trunk from revision 180 to 181.
	...
	function createElement($name, $value=null) {return @wp_shifty_tr_get_html("<$name>$value</$name>")->first_child();}
	function createTextNode($value) {return @end(wp_shifty_str_get_html($value)->nodes);}
