...
class WP_Shifty_Dom_Node {
	...
	function outertext()
	{
		...
		// render begin tag
		if ($this->dom && $this->dom->nodes[$this->_[0]])
		{
	...
	function text()
	{
		...
		$ret = '';
		// In rare cases, (always node type 1 or SWO_HDOM_TYPE_ELEMENT - observed for some span tags, and some p tags) $this->nodes is set to NULL.
