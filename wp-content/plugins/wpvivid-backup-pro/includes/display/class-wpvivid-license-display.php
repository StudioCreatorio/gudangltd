    ...
    public function welcome_bar()
    {
        ...
        <div class="wpvivid-welcome-bar wpvivid-clear-float">
            <div class="wpvivid-welcome-bar-left">
                ...
                <span class="about-description">Enter your license to activate <?php echo apply_filters('wpvivid_white_label_display', 'WPvivid'); ?> plugins and get plugin updates and support.</span>
            </div>
