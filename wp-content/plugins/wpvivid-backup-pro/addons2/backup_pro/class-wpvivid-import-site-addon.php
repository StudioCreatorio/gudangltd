...
class WPvivid_Import_Backup_List extends WP_List_Table
{
    ...
    public function _column_wpvivid_backup( $backup )
    {
        ...
        $html='
                    <div id="'.$backup['key'].'" type-string="'.$backup['content_detail'].'" backup-time="'.date('M-d-Y H:i', $localtime).'" backup-type="'.$backup['type'].'" backup-comment="'.$backup_prefix.'" backup-size="'.$size.'" style="border-bottom:1px solid #cccccc;">
